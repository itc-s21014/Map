...
import jp.ac.it_college.std.s21014.map.BuildConfig.MAPS_API_KEY
import jp.ac.it_college.std.s21014.map.databinding.ActivityMapBinding
...
class MapActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private fun onMarkerSet() {
        ...
        map?.setOnInfoWindowClickListener { marker ->
            ...
            val intent = Intent(this@MapActivity, SubActivity::class.java).apply {
                putExtra("id", id)
            }
            startActivity(intent)
